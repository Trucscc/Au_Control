...
function Pin_PWm(element) {
  ...
  var value_ = document.getElementById("thanh"+ number);    //console.log(sliderValue);
      document.getElementById("slider"+ number).value = parseInt(value_.value);

      db.ref().child(path1+ number).set(parseInt(value_.value));
      
      document.getElementById("slider"+ number).innerText = 'Brightness: ' + parseInt(value_.value)+ ' %'; 
      ...
      var path1 = uid + "/board_" + document.getElementById("level").value + "/outputs/digital/";
          for (var i = 0; i < 34; i++){
              if(i>=26 && i!=28 && i!=29 && i!=30 && i!=31){
                    ...
                    db.ref().child(path1+i).on('value', snap => { 
                           if (snap.val()>= 1 ){
                                  document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(233, 24, 42) ;"> ON</i> ';
                                  document.getElementById(i.toString()).checked = true;
                                  document.getElementById('thanh'+ i).style.display= "block" ;
                                  document.getElementById('slider'+i.toString()).innerText= 'Brightness: ' + snap.val() + ' %';
                                  document.getElementById('thanh'+i.toString()).value = snap.val() ;

                            }else{
                              document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(0, 0, 0) ;"> OFF</i> ';
                              document.getElementById(i.toString()).checked = false; 
                              document.getElementById('thanh'+ i).style.display= "none" ;
                              document.getElementById('slider'+i.toString()).innerText='' ; 
                             }
              ...
              /*if(i!=1 && i!=3 && i!=6 && i!=7 && i!=8 && i!=9 && i!=10 && i!=11 && i!=20 && i!=24 && i!=28 && i!=29 && i!=30 && i!=31){
                ...
                db.ref().child(path1+i).on('value', snap => {
                  if(snap.val() >= 1 && i<=25) {    
                      if( (snap.val()== 1 || snap.val()== 100) ) {
                          //document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(233, 24, 42) ;"> ON</i> ';
                          //document.getElementById(i.toString()).checked = true;
                          document.getElementById('thanh'+ i).style.display= "block" ;
                          document.getElementById('slider'+i.toString()).innerText= 'Brightness: ' + 100 + ' %' ;
                          document.getElementById('thanh'+i.toString()).value= 100 ;
                       }else if ((snap.val()>=2 && snap.val()<100)){
                          //document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(233, 24, 42) ;"> ON</i> ';
                          //document.getElementById(i.toString()).checked = true;
                          document.getElementById('thanh'+ i).style.display= "block" ;
                          document.getElementById('slider'+i.toString()).innerText= 'Brightness: ' + snap.val() + ' %';
                    ...
                    }else if(snap.val() == 0 && i<=25){
                        //document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(0, 0, 0) ;"> OFF</i> ';
                        //document.getElementById(i.toString()).checked = false;
                        document.getElementById('thanh'+ i).style.display= "none" ;
                        document.getElementById('slider'+i.toString()).innerText='' ; 
                    }else if(i>=26 && snap.val() == 1){
                        document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(233, 24, 42) ;"> ON</i> ';
                        document.getElementById(i.toString()).checked = true;
                    }else if(snap.val() == 0 && i>=26){
                        document.getElementById('state'+i.toString()).innerHTML = '<i class="fas fa-lightbulb" style="color: rgb(0, 0, 0) ;"> OFF</i> ';
                        document.getElementById(i.toString()).checked = false;
                  }
